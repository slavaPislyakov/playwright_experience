...
- [ ] создать корректный docker файл для запуска тестов
- [ ] создать мейк файл (если нужно)
- [ ] создать ямл файл для рана тестов в гитхабе
- [ ] создать ямл файл для рана тестов в гитлабе
- [ ] удалить все разделения на проекте и запускать все тесты: апи + юай
- [ ] заиспользовать мейк в сиайке
---